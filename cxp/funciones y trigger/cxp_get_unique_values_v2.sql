--[Fecha y Hora]: 13/11/2025 18:52:00
--[Descripción]: Obtiene valores únicos para los filtros del reporte CXP (versión corregida)
--
--[Parámetros]:
...
--   SELECT * FROM cxp_get_unique_values_v2(1);
--   
--   -- Obtener todas las categorías únicas
--   SELECT * FROM cxp_get_unique_values_v2(2);
--   
--   -- Obtener todos los años disponibles
--   SELECT * FROM cxp_get_unique_values_v2(4);
--
--[Relaciones]: 
--   - Tabla principal: cxp
...
CREATE OR REPLACE FUNCTION public.cxp_get_unique_values_v2(tipo_dato integer)
...
BEGIN
    ...
    --   tipo_dato (INTEGER) - Tipo de dato a obtener:
    --     1 = Proveedores (razonSocial)
    --     2 = Categorías (descripcion) - TABLA CORRECTA
    --     3 = Secciones (seccion) - TABLA CORRECTA
    --     4 = Años (extraído de fecSolicitud)
    --     5 = Usuarios solicitantes
    --     6 = Usuarios autorizadores
    --     7 = Usuarios pagadores
    -- [Retorna]: TABLE con columna valor (TEXT)
    -- [Uso]: SELECT * FROM cxp_get_unique_values_v2(1);
