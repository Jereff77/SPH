--[Fecha y Hora]: 13/11/2025 18:51:00
--[Descripción]: Obtiene el estado de cuenta detallado de CXP con múltiples filtros (versión corregida)
--
--[Parámetros]:
...
--
--[Ejemplo]: SELECT * FROM cxp_get_estado_cuenta_detalle_v2(2025, 8, NULL, 'Mantenimiento', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
--
--[Relaciones]: 
--   - Tabla principal: cxp
...
--   - Función de tipo SECURITY INVOKER (ejecuta con permisos del usuario que la llama)
...
CREATE OR REPLACE FUNCTION public.cxp_get_estado_cuenta_detalle_v2(
...
BEGIN
    ...
    -- [Uso]: SELECT * FROM cxp_get_estado_cuenta_detalle_v2(2025, 8);
