...
async def run_test():
    ...
    try:
        ...
        # -> Resize viewport to 375px width and verify UI elements again.
        ...
        # -> Resize viewport to 414px width and verify UI elements again.
        await page.goto('http://localhost:5173/', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Resize viewport to 480px width and verify UI elements again.
        await page.goto('http://localhost:5173/', timeout=10000)
        await asyncio.sleep(3)
