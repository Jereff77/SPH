...
async def run_test():
    ...
    try:
        ...
        # -> Enter the valid email and password, then click the login button to complete login.
        ...
        # -> Log out of the application to test email persistence on login page.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=jereff@aceleremos.com').first).to_be_visible(timeout=30000)
