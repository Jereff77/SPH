...
async def run_test():
    ...
    try:
        ...
        # -> Input username and password, then click login button to access visitor registration form
        ...
        # -> Input phone number with letters and special characters more than 10 digits into phone number field
        frame = context.pages[-1]
        # Input phone number with letters and special characters more than 10 digits
        elem = frame.locator('xpath=html/body/div/div/main/section[2]/div[2]/input[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('abc123!@#4567890xyz')
        ...
        # -> Attempt to input more than 10 numeric digits into the phone number field to verify truncation and limit enforcement
        frame = context.pages[-1]
        # Input more than 10 numeric digits to test truncation and limit enforcement
        elem = frame.locator('xpath=html/body/div/div/main/section[2]/div[2]/input[2]').nth(0)
