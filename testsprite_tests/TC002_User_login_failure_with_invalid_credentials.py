...
async def run_test():
    ...
    try:
        ...
        # -> Enter an unregistered or malformed email address in the email input field.
        frame = context.pages[-1]
        # Enter an unregistered or malformed email address
        elem = frame.locator('xpath=html/body/div/div/div/form/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('invalidemail@wrongdomain.com')
