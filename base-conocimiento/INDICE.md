...
| Configuraciones | ✅ desarrollado | `modulos/configuraciones.md` | /configuraciones/* · /registro | 200, 203, 210, 220, 221 | usuarios, invitación, invitar usuario, registro, alta de usuario, parámetros, permisos, plantillas, INPC, cuentas, fechas CxP, logos, dominios, matriz de permisos, reporte de permisos, descargar permisos, quién tiene acceso a qué, para qué sirve el permiso, descripción del permiso, qué hace este permiso |
...
| KVA's | ✅ desarrollado | `modulos/kvas.md` | /parques/kvas | 720, 721, 722, 723 | kva, energía, electricidad, tensión, media tensión, baja tensión, acometida, CFE, capacidad eléctrica, contrato de CFE, devolución de KVA, no me deja liberar la nave, faltan KVA por regresar, disponibles en negativo, sobregiro, vendidos o rentados, expediente de la nave, documentos de la nave, carta de compra de KVA, quién renta la nave, el parque sale en ceros |
...
| Pendientes (tablero del proyecto) | ✅ desarrollado | `modulos/pendientes.md` | /configuraciones/pendientes | — (solo soporte, isSupport) | pendientes, tablero de pendientes, backlog, deuda técnica, dónde registro esto, dónde anoto la deuda, una sola fuente, bug conocido, decisión abierta, qué falta por hacer, qué sigue, prioridades, P0, bloqueado |
...
| `dev_pendientes` | Pendientes — tablero del proyecto (solo soporte) |
...
| `/configuraciones/pendientes` | Pendientes — tablero del proyecto (solo soporte) |
